...
const unsigned char ASCII24[][48] =
{
...
const unsigned char ASCII32[][64] =
{
...
// 24 ºÅ 72 ×Ö½Ú
// 32 ºÅ 128×Ö½Ú
unsigned char FontIndex[][2] =
{
    "Ï£", "Íû", "¼ê", "Ä¬"
};

unsigned char FONT12[] =
{
    0x06, 0x02, 0x98, 0x01, 0x60, 0x00, 0x9E, 0x01,
    0x08, 0x02, 0xFF, 0x07, 0x24, 0x00, 0xFE, 0x03,
    0x25, 0x02, 0x24, 0x02, 0x24, 0x03, 0x20, 0x00,  /* "Ï£" 0 */

    0xC4, 0x07, 0x48, 0x04, 0xDF, 0x07, 0x42, 0x04,
    0xC2, 0x07, 0x5E, 0x04, 0x20, 0x06, 0xFE, 0x03,
    0x20, 0x00, 0xFC, 0x01, 0x20, 0x00, 0xFF, 0x07,  /* "Íû" 1 */

    0x02, 0x05, 0x02, 0x01, 0xF1, 0x07, 0x15, 0x01,
    0x73, 0x01, 0x12, 0x05, 0x71, 0x05, 0x57, 0x03,
    0x50, 0x03, 0x74, 0x05, 0x93, 0x06, 0x48, 0x04,  /* "¼ê" 2 */

    0x3F, 0x01, 0x29, 0x03, 0x3B, 0x05, 0x29, 0x01,
    0xBF, 0x07, 0x08, 0x01, 0x3F, 0x01, 0x08, 0x01,
    0xB8, 0x02, 0x87, 0x02, 0xAA, 0x02, 0x55, 0x04   /* "Ä¬" 3 */
};

unsigned char FONT16[] =
{
    0x18, 0x18, 0x60, 0x06, 0x80, 0x01, 0x60, 0x06,
    0x5C, 0x18, 0x40, 0x00, 0xFF, 0x7F, 0x20, 0x01,
    0x10, 0x01, 0xF8, 0x1F, 0x14, 0x11, 0x12, 0x11,
    0x11, 0x15, 0x10, 0x09, 0x00, 0x01, 0x00, 0x01,  /* "Ï£" 0 */

    0x08, 0x00, 0x10, 0x3E, 0xFF, 0x22, 0x04, 0x3E,
    0x04, 0x22, 0x64, 0x3E, 0x1C, 0x22, 0x04, 0x29,
    0x80, 0x10, 0xFE, 0x3F, 0x80, 0x00, 0x80, 0x00,
    0xFC, 0x1F, 0x80, 0x00, 0x80, 0x00, 0xFF, 0x7F,  /* "Íû" 1 */

    0x04, 0x28, 0x04, 0x48, 0x04, 0x08, 0xE2, 0x7F,
    0x2A, 0x08, 0x2F, 0x08, 0xA4, 0x0B, 0x24, 0x48,
    0x22, 0x48, 0xAF, 0x2B, 0xA2, 0x2A, 0xA0, 0x12,
    0xAC, 0x5B, 0x23, 0x54, 0x10, 0x62, 0x08, 0x41,  /* "¼ê" 2 */

    0x00, 0x04, 0x7F, 0x14, 0x49, 0x24, 0x6B, 0x24,
    0x5D, 0x04, 0xC9, 0x7F, 0x7F, 0x04, 0x08, 0x04,
    0x7F, 0x04, 0x08, 0x0A, 0x78, 0x0A, 0x07, 0x0A,
    0x40, 0x11, 0x55, 0x11, 0x95, 0x20, 0x41, 0x40   /* "Ä¬" 3 */
};

unsigned char FONT24[] =
{
    0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0xE0, 0x80,
    0x03, 0x00, 0x67, 0x00, 0x00, 0x38, 0x00, 0x00,
    0xEC, 0x00, 0x00, 0x83, 0x03, 0xE0, 0x0C, 0x06,
    0x18, 0x06, 0x14, 0xFE, 0xFF, 0x3F, 0x00, 0x0B,
    0x00, 0x80, 0x11, 0x00, 0x80, 0x10, 0x00, 0xC0,
    0xFF, 0x0F, 0xE0, 0x10, 0x04, 0xD8, 0x10, 0x04,
    0xC4, 0x10, 0x04, 0xC2, 0x10, 0x04, 0xC0, 0x10,
    0x04, 0xC0, 0x90, 0x07, 0xC0, 0x10, 0x02, 0x00,
    0x10, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00,  /* "Ï£" 0 */

    0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x40, 0x00,
    0x00, 0xC0, 0xF0, 0x1F, 0x40, 0x20, 0x18, 0xFE,
    0x27, 0x18, 0x10, 0xE0, 0x1F, 0x10, 0x30, 0x18,
    0x10, 0xF0, 0x1F, 0x10, 0x36, 0x18, 0x90, 0x11,
    0x18, 0x70, 0x08, 0x1E, 0x10, 0x04, 0x08, 0x00,
    0x02, 0x08, 0xF8, 0xFF, 0x1F, 0x00, 0x08, 0x00,
    0x00, 0x08, 0x00, 0xF0, 0xFF, 0x07, 0x00, 0x08,
    0x00, 0x00, 0x08, 0x00, 0x00, 0x08, 0x10, 0xFE,
    0xFF, 0x3F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  /* "Íû" 1 */

    0x00, 0x00, 0x00, 0x20, 0x00, 0x01, 0x30, 0x00,
    0x03, 0x10, 0x00, 0x1B, 0x10, 0x00, 0x13, 0x08,
    0x02, 0x23, 0x88, 0xFF, 0x7F, 0x84, 0x04, 0x03,
    0x7A, 0x04, 0x03, 0x46, 0xFC, 0x02, 0x20, 0x04,
    0x32, 0x10, 0x04, 0x12, 0x08, 0xF4, 0x1A, 0xC4,
    0x96, 0x0A, 0x3C, 0x96, 0x0A, 0x04, 0x92, 0x0A,
    0x00, 0x92, 0x06, 0x80, 0xF2, 0x44, 0x70, 0x92,
    0x46, 0x0C, 0x01, 0x49, 0x80, 0x80, 0x38, 0x40,
    0x60, 0x70, 0x20, 0x10, 0x40, 0x00, 0x00, 0x00,  /* "¼ê" 2 */

    0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x80,
    0x01, 0xFC, 0x87, 0x04, 0x44, 0x86, 0x18, 0x44,
    0x87, 0x18, 0xD4, 0x86, 0x10, 0x54, 0x86, 0x20,
    0xFC, 0xFF, 0x3F, 0x44, 0x86, 0x01, 0x40, 0x80,
    0x02, 0x40, 0x80, 0x02, 0xFC, 0x87, 0x02, 0x40,
    0x80, 0x02, 0x40, 0x80, 0x02, 0x40, 0xC7, 0x02,
    0xF8, 0x40, 0x04, 0x0C, 0x44, 0x04, 0x80, 0x68,
    0x0C, 0x20, 0x29, 0x08, 0x64, 0x11, 0x18, 0x64,
    0x08, 0x30, 0x04, 0x04, 0x10, 0x00, 0x02, 0x00   /* "Ä¬" 3 */
};

unsigned char FONT32[] =
{
    ,  /* "Ï£" 0 */

    ,  /* "Íû" 1 */

    ,  /* "¼ê" 2 */

       /* "Ä¬" 3 */
};
